...
namespace LaunchDarkly.Tests
{
    public class FlagFileDataTest
    {
        ...
        [Fact]
        public void AddToData_DuplicateKeysHandling_OverwriteWithNewerVersion()
        {
            const string key = "flag1";
            ...
            fileData.AddToData(data, DuplicateKeysHandling.OverwriteIfNewerVersion);

            IVersionedData postFeatureFlag = data[VersionedDataKind.Features][key];
            Assert.NotSame(initialFeatureFlag, postFeatureFlag);
            Assert.Equal(1, postFeatureFlag.Version);
        }

        [Fact]
        public void AddToData_DuplicateKeysHandling_IgnoreOlderVersion()
        {
            const string key = "flag1";

            FeatureFlag initialFeatureFlag = new FeatureFlag(key, version: 1, deleted: false);
        ...
        [Fact]
        public void AddToData_DuplicateKeysHandling_IgnoreSameVersion()
        {
            const string key = "flag1";
