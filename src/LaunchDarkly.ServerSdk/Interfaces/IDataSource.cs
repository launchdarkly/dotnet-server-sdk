...
namespace LaunchDarkly.Sdk.Server.Interfaces
{
    ...
    /// <see cref="IDataSourceUpdates"/> component, which is a write-only abstraction of the data store.
    /// The SDK never requests feature flag data from the <see cref="IDataSource"/>, it only looks at
