...
//
// <NamespaceSummaries>
//   <NamespaceSummaryItem name="LaunchDarkly.Sdk.Server.Internal.DataSources" isDocumented="True" xmlns="">
//     ...summary here...
...
{
    /// <summary>
    /// INTERNAL namespace for <see cref="LaunchDarkly.Sdk.Server.Interfaces.IDataSource"/> implementations
    /// and related internal SDK types. These types should not be public and should not appear in
    /// documentation.
    /// </summary>
